          ...
          <div className="hidden lg:block">
            <h1 className="text-lg lg:text-xl font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2.5">
              ...
              {persona === "admin" ? (
                ...
                <span className="text-[10px] font-mono font-bold text-violet-700 bg-violet-100 border border-violet-200 dark:text-violet-400 dark:bg-violet-500/10 dark:border-violet-500/20 px-2.5 py-0.5 rounded-full uppercase flex items-center gap-1">
                  <BadgeCheck className="w-3 h-3 text-violet-600 dark:text-violet-400" />{" "}
                  Pro Member
                </span>
              ) : null}
            </h1>
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <div ref={avatarRef} className="relative">
            <button
              ...
              className="flex items-center gap-1.5 rounded-full p-0.5 ring-2 ring-violet-500/30 hover:ring-violet-500/60 focus:ring-violet-500/70 transition-all cursor-pointer outline-none active:scale-95"
        ...
        <div className="fixed inset-0 z-50 lg:hidden flex">
          ...
          >
            ...
            <div className="p-4 border-b border-slate-100 dark:border-slate-800/60 shrink-0">
              <div className="flex items-center space-x-3 rounded-2xl bg-slate-50 dark:bg-[#0D1528] p-3 border border-slate-200/80 dark:border-slate-800/80 shadow-xs">
