...
export default function AdminProfileWrapper({ initialUser }) {
  ...
  return (
    <div className="p-8 space-y-6 max-w-4xl font-sans">
      ...
      <div className="rounded-2xl p-6 bg-[#0D1528] border border-slate-800 space-y-6 shadow-sm">
        <div className="flex flex-col sm:flex-row items-start justify-between gap-6 pb-6 border-b border-slate-800">
          <div className="flex items-center gap-5">
            <div className="relative">
              <img
                src={profile.image}
                alt={profile.name}
                className="w-20 h-20 rounded-2xl object-cover ring-2 ring-purple-500/40 bg-[#060C1A] shadow-inner"
              />
              <div
                className="absolute -bottom-1.5 -right-1.5 bg-purple-600 text-white p-1 rounded-xl ring-2 ring-[#0D1528] shadow-md"
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="flex items-center gap-1 bg-purple-500/10 border border-purple-500/20 text-purple-400 text-[11px] font-mono font-bold px-2.5 py-0.5 rounded-full">
          ...
          <div className="flex sm:flex-col gap-2 w-full sm:w-auto">
            <span className="text-[11px] font-mono text-purple-300 bg-purple-500/10 border border-purple-500/20 px-3 py-1.5 rounded-xl text-center">
              Tier: <strong>Full Admin Bypass</strong>
            </span>
            <span className="text-[11px] font-mono text-slate-400 bg-white/5 border border-slate-800 px-3 py-1.5 rounded-xl text-center">
              Role ID: <strong className="text-slate-200">admin_root</strong>
            </span>
          </div>
        </div>
      ...
      <div className="rounded-2xl p-6 bg-[#0D1528] border border-slate-800 space-y-4 shadow-sm">
        <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
          <div className="p-3.5 rounded-xl bg-[#060C1A] border border-slate-800 flex items-start gap-3">
