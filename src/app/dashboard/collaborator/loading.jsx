  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            <div className="h-8 w-64 rounded-xl bg-slate-200/80 dark:bg-slate-800/80 animate-pulse" />
        ...
        <div className="h-9 w-40 rounded-2xl bg-slate-100 dark:bg-slate-800 animate-pulse" />
      </div>
        ...
        {[...Array(4)].map((_, i) => (
          ...
          >
            <div className="space-y-2.5 flex-1">
              ...
              <div className="h-7 w-16 rounded-lg bg-slate-200/90 dark:bg-slate-800/90 animate-pulse" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Activity Metric Bar Chart Skeleton */}
        <div className="lg:col-span-2 rounded-3xl p-6 bg-white border border-slate-200/90 shadow-sm dark:bg-slate-900/80 dark:border-slate-800/90 space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-1.5">
              ...
              <div className="h-3 w-60 rounded bg-slate-200/60 dark:bg-slate-800/60 animate-pulse" />
            </div>
        ...
        {/* Application Status Donut Breakdown Skeleton */}
