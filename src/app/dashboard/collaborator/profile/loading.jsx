...
export default function CollaboratorProfileLoading() {
  return (
      ...
      <div className="rounded-3xl p-6 sm:p-8 bg-white border border-slate-200/90 shadow-sm dark:bg-slate-900/80 dark:border-slate-800/90 space-y-6">
        <div className="flex flex-col sm:flex-row items-start gap-6">
          ...
          <div className="space-y-2 flex-1">
            ...
            <div className="h-4 w-56 rounded bg-slate-200/70 dark:bg-slate-800/70 animate-pulse" />
            <div className="h-4 w-32 rounded-full bg-slate-100 dark:bg-slate-800 animate-pulse" />
          </div>
        </div>

        <div className="h-20 w-full rounded-2xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200/60 dark:border-slate-800/60 animate-pulse" />

        <div className="space-y-2">
          <div className="h-3.5 w-24 rounded bg-slate-200/80 dark:bg-slate-800/80 animate-pulse" />
          <div className="flex flex-wrap gap-2">
            {[...Array(5)].map((_, i) => (
              <div
                key={i}
                className="h-7 w-20 rounded-lg bg-slate-100 dark:bg-slate-800 animate-pulse"
              />
            ))}
          </div>
        </div>
