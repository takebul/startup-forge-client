...
export default function UnauthorizedPage() {
  ...
  return (
    <div className="relative min-h-[85vh] flex items-center justify-center p-6 font-sans overflow-hidden bg-white text-slate-900 transition-colors duration-200 dark:bg-slate-950 dark:text-slate-100">
      ...
      <div className="pointer-events-none absolute -top-40 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-red-500/10 blur-3xl dark:bg-red-600/15" />
      <div className="pointer-events-none absolute -bottom-40 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-violet-500/10 blur-3xl dark:bg-violet-600/15" />
      ...
      <div className="relative w-full max-w-lg">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 mb-6">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-red-500/20 bg-red-50 px-3.5 py-1 text-xs font-mono font-bold text-red-600 dark:bg-red-500/10 dark:text-red-400 uppercase tracking-wider">
          ...
          {/* Central Shield Icon */}
          <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-2xl bg-red-100 text-red-600 dark:bg-red-500/10 dark:text-red-400 shadow-inner mb-6">
          ...
          {isLoggedIn ? (
            <div className="mt-6 rounded-2xl border border-slate-200/80 bg-slate-50/80 p-4 text-left dark:border-slate-800 dark:bg-slate-950/60">
            ...
            <div className="mt-6 rounded-2xl border border-slate-200/80 bg-slate-50/80 p-4 text-xs text-slate-600 dark:border-slate-800 dark:bg-slate-950/60 dark:text-slate-400">
