...
export default function ForbiddenPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0C10] font-sans text-slate-300 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute -top-40 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-rose-500/10 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-40 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-amber-500/10 blur-3xl" />
      ...
      <div className="relative w-full max-w-lg">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 mb-6">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-rose-500/30 bg-rose-500/10 px-3.5 py-1 text-[11px] font-mono font-bold text-rose-400 uppercase tracking-wider">
          ...
          <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-2xl bg-rose-500/10 text-rose-400 border border-rose-500/20 shadow-lg shadow-rose-500/5 mb-6">
          ...
          {isLoggedIn ? (
            <div className="mt-6 rounded-2xl border border-slate-800 bg-[#060C1A] p-4 text-left space-y-2">
            ...
            <div className="mt-6 rounded-2xl border border-slate-800 bg-[#060C1A] p-4 text-xs text-slate-400 text-center font-mono">
