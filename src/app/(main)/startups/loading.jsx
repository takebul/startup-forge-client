  ...
  return (
    <div className="relative min-h-screen overflow-hidden py-10 md:py-14 font-sans text-slate-900 dark:text-slate-100">
      <div className="container relative mx-auto px-6 lg:px-12 max-w-6xl space-y-10">
        ...
        {/* ===================================================================
            2. SEARCH & FILTER CONTROLS SKELETON
            =================================================================== */}
        ...
        {/* ===================================================================
            3. STARTUPS CARDS 6-GRID SKELETON
            =================================================================== */}
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[...Array(6)].map((_, idx) => (
            ...
            >
              <div>
                {/* Logo & Funding Stage Pill */}
                <div className="flex items-start justify-between gap-4">
                  <div className="h-14 w-14 rounded-2xl bg-slate-200/80 dark:bg-slate-800/80 animate-pulse shrink-0" />
                  <div className="h-6 w-20 rounded-full bg-slate-100 dark:bg-slate-800/80 animate-pulse" />
                </div>

                {/* Startup Name & Founder Info */}
                <div className="mt-4 space-y-2">
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    ...
                    <div className="h-3.5 w-24 rounded bg-slate-200/70 dark:bg-slate-800/70 animate-pulse" />
                  </div>
                </div>
                ...
                <div className="mt-4 space-y-1.5">
                  ...
                  <div className="h-3.5 w-4/5 rounded bg-slate-200/60 dark:bg-slate-800/60 animate-pulse" />
                </div>

                {/* Industry & Open Roles Badges */}
                <div className="mt-5 flex flex-wrap gap-2">
                  <div className="h-6 w-24 rounded-full bg-slate-100 dark:bg-slate-800/80 animate-pulse" />
                  <div className="h-6 w-28 rounded-full bg-slate-100 dark:bg-slate-800/80 animate-pulse" />
                </div>
              </div>

              {/* Card Footer */}
              <div className="border-t border-slate-100 pt-4 dark:border-slate-800/80 flex items-center justify-between">
                <div className="h-3.5 w-20 rounded bg-slate-200/60 dark:bg-slate-800/60 animate-pulse" />
